...
export default class Index extends Component<IndexProps, IndexState> {
  ...
  getTemplateData = async (value?: string) => {
    ...
    let res = (await request.get(`/api/template-trees?${paramsStr}page=0&size=500`)).data;
    res = res || [];
  ...
  renderNodeTreeMenu() {
    ...
    return nodeTreeItem && editable ? (
      <div style={menuStyle}>
        ...
        <div className="handle-icon" onClick={() => this.handleTreeSort('UP')}>
  ...
  render() {
    ...
    return (
      <div className="template-tree-wrapper">

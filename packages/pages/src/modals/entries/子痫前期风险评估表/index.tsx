...
interface IProps {
  ...
  // diagnosesList: IMchc_Doctor_RvisitInfoOfOutpatient_Diagnoses[]
}
export default function Preeclampsia(props: IGlobalModalProps<IProps>) {
  ...
  useEffect(() => {
    (
      async () => {
        const pregnancyId = get(headerInfo, `id`) || getSearchParamsValue('id');

...
export function ExtHistory({ ext, config, recordId }: IProps) {
    const [list, set_list] = useState<IItem[]>([
        ...
        { modifiedDate: '2025-10-22 12:44:01', version: 1, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 2, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 3, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 4, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 5, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 6, modifiedBy: 'admin' },
        { modifiedDate: '2025-10-22 12:44:01', version: 7, modifiedBy: 'admin' },
    ...
    useEffect(() => {
        request.get<IItem[]>(`/api/assessment/${ext_value}/historyList`, { params: base_args })
            .then(res => {
                const arr = res.data
                set_list(arr)
                if (arr.length)
    ...
    function getDetail(item: IItem) {
        request
            .get<AnyObject>(`/api/assessment/${ext_value}/historyDetail`, { params: item })

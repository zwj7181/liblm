...
export const routesData = {
    "bf_form":lazy(() => import("./entries/BF_Form/index")),
    "box":lazy(() => import("./entries/box/index")),
    "modal_form":lazy(() => import("./entries/modal_form/index")),
    "modal_page":lazy(() => import("./entries/modal_page/index")),
    "print_modal":lazy(() => import("./entries/print_modal/index")),
    "result_template":lazy(() => import("./entries/result_template/index")),
    ...
    "瘢痕子宫阴道试产表":lazy(() => import("./entries/瘢痕子宫阴道试产表/index")),

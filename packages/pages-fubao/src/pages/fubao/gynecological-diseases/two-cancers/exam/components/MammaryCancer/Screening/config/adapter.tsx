...
export const valueToForm = (values: any, nativeFormDescriptions: any) => {
  ...
  //辅助检查 没报告显示未查
  if (!get(values, 'breastCancerAuxiliaryExamination.breastUltrasoundExamination')) {
    set(values, 'breastCancerAuxiliaryExamination.breastUltrasoundExamination', {
      key: 2,
      keyNote: undefined,
    });
  }
  if (!get(values, 'breastCancerAuxiliaryExamination.breastXBiRadsExamination')) {
    set(values, 'breastCancerAuxiliaryExamination.breastXBiRadsExamination', {
      key: 2,
      keyNote: undefined,
    });
  }

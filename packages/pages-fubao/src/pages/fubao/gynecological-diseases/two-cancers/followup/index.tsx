...
export default function TowCancerFollowup(props: { id?: TIdTypeCompatible }) {
    ...
    useEffect(() => {
        request
            .get(`/api/two/cancer/followup/twoCancerScreeningHeader/${twoCancerScreeningId}`, { ignore_usr: true, unboxing: true, params: {} })
            .then(r => {
    ...
    return <>
        <PanelTitleWrapper headerItems={[
            ...
            {
                <MyBaseList
                    // name="/api/two/cancer/followup/getTwoCancerFollowupCase"
                    name="/api/two/cancer/followup/twoCancerFollowupCase"
                    useListSourceCount
                    // showAdd={false}
                    // showAction={false}
                    // dbg_dataSource={list}
                    ...
                    // }}
                    beforeSubmit={v => Object.assign(v, { twoCancerScreeningId })}
                    ignore_usr
                    searchParams={{

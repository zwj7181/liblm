...
import form_config from '../../../premarital-care/.public-exam/PhysicalExamination/form_config';
...
export default function PhysicalExamination(props: IProps) {
  ...
  async function handleSubmit(values: any) {
    ...
    const baseUrl = '/api/progestation/check/saveProgestationCheckArchivesPhysicalExamination'
    let params = values;

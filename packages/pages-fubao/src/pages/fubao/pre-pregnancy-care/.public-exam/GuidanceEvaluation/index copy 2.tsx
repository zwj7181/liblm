...
import form_config from '../../../premarital-care/.public-exam/GuidanceEvaluation/form_config';
...
export default function PhysicalExamination(props: IProps) {
  ...
  async function handleSubmit(values: any) {
    ...
    const baseUrl = '/api/progestation/check/saveProgestationCheckArchivesGuidanceAsses'
    let params = values;

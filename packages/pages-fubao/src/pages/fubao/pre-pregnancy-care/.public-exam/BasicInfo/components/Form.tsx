    ...
    handleIDNumberChange: (id: string) => {
      ...
      if (type === 'husband') {
        if (id === 'permanentResidenceAddress') {
          const value = get(
            filesData,
            'womanProgestationCheckArchivesDetailVM.progestationCheckArchivesBasicInformation.permanentResidenceAddress',
          );
        ...
        if (id === 'residenceAddress') {
          const value = get(
            filesData,
            'womanProgestationCheckArchivesDetailVM.progestationCheckArchivesBasicInformation.residenceAddress',
          );

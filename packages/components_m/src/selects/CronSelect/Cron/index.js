      ...
      <div className="cron-select" style={style}>
        <Tabs defaultActiveKey={String(TabsActiveKey)} onChange={this.callback}>
          ...
          {this.isShowDom('minute', type) && (
            <Tabs.TabPane tab={i18n.minute} key="2">
          ...
          {this.isShowDom('hour', type) && (
            <Tabs.TabPane tab={i18n.hour} key="3">
          ...
          {this.isShowDom('day', type) && (
            <Tabs.TabPane tab={i18n.day} key="4">
              <RadioGroup name="radiogroup" value={daysRadiochecked} onChange={this.onDaysRadioChange}>
                ...
                {/* <Radio style={radioStyle} value={5}>
                  {i18n.Everymonth1} <InputNumber disabled={daysRadiochecked !== 5} min={1} max={31} value={daysForWorking} onChange={this.daysForWorking} style={{ width: 100 }} /> {i18n.latestDays}
                </Radio>
          ...
          {this.isShowDom('month', type) && (
            <Tabs.TabPane tab={i18n.month} key="5">
          ...
          {this.isShowDom('week', type) && (
            <Tabs.TabPane tab={i18n.week} key="6">
          ...
          {/* <Tabs.TabPane tab="年" key="7">
            <RadioGroup name="radiogroup" defaultValue={1} onChange={this.onYearRadioChange}>
              ...
              <Radio style={radioStyle} value={3}>
                  {i18n.from} <InputNumber type="number" onChange={this.yearCycleStart} style={{ width: 100 }} />
                  - <InputNumber type="number" onChange={this.yearCycleEnd} style={{ width: 100 }} />
              </Radio>
            </RadioGroup>
          </Tabs.TabPane> */}
        </Tabs>
